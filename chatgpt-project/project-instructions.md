...
> **CANDIDATE SMOKE ONLY / NOT ACCEPTED STABLE RELEASE**  
> 版本：smoke/issue-33/7effe658  
> 用途：复制到独立测试专用 ChatGPT Project → Instructions 进行候选运行时冒烟测试（严禁覆盖生产 Project）。
...
WORKFLOW_REF: smoke/issue-33/7effe658
```
